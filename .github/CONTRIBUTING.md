...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository
   at [`sslakkimsetty/paradise_circus`](https://github.com/sslakkimsetty/paradise_circus)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/paradise_circus.git`
...
```shell
$ git remote add sslakkimsetty https://github.com/sslakkimsetty/paradise_circus.git
```
